\documentclass[12pt, a4paper,twoside]{report}
	...
	\begin{document} % Start your document
		...
		\end{itemize}
			...
			\begin{figure}[h!]
				\centering
				\textbf{Denial Rates By Plan Type, Federal Marketplace, 2021}\par\medskip
				\includegraphics[width=.49\columnwidth]{images/cms_puf/PPO_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/EPO_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/POS_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/HMO_dist.png}
				\caption{Distribution of claims denial rates broken down by plan types. From left to right, top to bottom: PPO, EPO, POS and HMO plan distributions.}
			...
			\begin{figure}[h!]
				\centering
				\textbf{Denial Rates By Metal Level, Federal Marketplace, 2021}\par\medskip
				\includegraphics[width=.49\columnwidth]{images/cms_puf/Catastrophic_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/Bronze_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/Bronze Expanded_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/Silver_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/Gold_dist.png}
				\includegraphics[width=.49\columnwidth]{images/cms_puf/Platinum_dist.png}
